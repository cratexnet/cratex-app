...
- [Política de privacidade](https://cratex.app/pt/privacy)
- [Política de cookies](https://cratex.app/pt/cookie-policy)
- [Termos de uso](https://cratex.app/pt/terms)

## 🌍 Idioma

[English](README.md) | [正體中文](README_zh-TW.md) | [简体中文](README_zh-CN.md) | [日本語](README_ja.md) | [한국어](README_ko.md) | [ไทย](README_th.md) | [Bahasa Indonesia](README_id.md) | [Tiếng Việt](README_vi.md) | [हिन्दी](README_hi.md) | [Français](README_fr.md) | [Deutsch](README_de.md) | [Español](README_es.md) | [Italiano](README_it.md) | [Nederlands](README_nl.md) | [Polski](README_pl.md) | Português | [Русский](README_ru.md) | [Türkçe](README_tr.md) | [العربية](README_ar.md)
...
- [Reconhecimento de código de barras](https://cratex.app/pt/barcode-decoder)
- [Calculadora de porcentagem](https://cratex.app/pt/percentage-calculator)
- [Conversor de unidades](https://cratex.app/pt/unit-converter)
- [Calculadora de idade](https://cratex.app/pt/age-calculator)
- [Calculadora de datas](https://cratex.app/pt/date-calculator)
...
- [Conversor de fusos horários](https://cratex.app/pt/time-zone-converter)
...
- [Cara ou coroa](https://cratex.app/pt/coin-flip)

#### 📝 [Processamento de texto](https://cratex.app/pt/cat/text)

- [Contador de Texto](https://cratex.app/pt/text-counter)
- [Formatador de texto](https://cratex.app/pt/text-formatter)
- [Limpar Unicode](https://cratex.app/pt/unicode-cleaner)
- [Limpar listas](https://cratex.app/pt/list-cleaner)
- [Localizar e substituir texto](https://cratex.app/pt/find-replace)
- [Extrair dados de texto](https://cratex.app/pt/text-pattern-extractor)
- [Visualizador de diferenças de texto](https://cratex.app/pt/text-diff)
- [Conversor de maiúsculas/minúsculas](https://cratex.app/pt/case-converter)
- [Gerador de slug](https://cratex.app/pt/slug-generator)
- [Conversor de Markdown](https://cratex.app/pt/markdown-converter)

#### 🖼️ [Ferramentas de imagem](https://cratex.app/pt/cat/image)

- [Conversão de formato de imagem](https://cratex.app/pt/image-converter)
- [Imagem para texto](https://cratex.app/pt/image-to-text)
- [Redimensionamento de imagem](https://cratex.app/pt/image-resizer)
- [Compressão de imagem](https://cratex.app/pt/image-compressor)
- [Recorte de imagem](https://cratex.app/pt/image-cropper)
- [Marca d'Água de Imagem](https://cratex.app/pt/image-watermarker)
- [Mesclar imagens](https://cratex.app/pt/image-merger)
- [Juntar capturas longas](https://cratex.app/pt/screenshot-stitcher)
- [Seletor de Cor de Imagem e Paleta](https://cratex.app/pt/image-color-picker)
- [Limpador de Metadados de Imagem](https://cratex.app/pt/image-metadata-cleaner)
- [Ocultar dados em imagens](https://cratex.app/pt/image-redactor)
...
- [Extrair áudio de vídeo](https://cratex.app/pt/extract-audio-from-video)
- [Silenciar vídeo](https://cratex.app/pt/remove-audio-from-video)
- [Cortar áudio](https://cratex.app/pt/trim-audio)
- [Áudio para WAV](https://cratex.app/pt/audio-to-wav)
- [Extrair quadro de vídeo](https://cratex.app/pt/video-frame-extractor)
- [M4A para MP3](https://cratex.app/pt/m4a-to-mp3)
- [Aparar vídeo](https://cratex.app/pt/trim-video)
- [Comprimir vídeo](https://cratex.app/pt/compress-video)
- [Comprimir áudio](https://cratex.app/pt/audio-compressor)

#### 🔄 [Codificação e conversão](https://cratex.app/pt/cat/encoding)

- [Codificação/decodificação de URL](https://cratex.app/pt/url-encoder)
- [Parser de URL](https://cratex.app/pt/url-parser)
- [Base64 Codificar/Decodificar](https://cratex.app/pt/base64-encoder)
- [Escapar e desescapar JSON](https://cratex.app/pt/json-escape)
- [HTML Escape/Desescape](https://cratex.app/pt/html-encoder)
- [Conversor Unicode](https://cratex.app/pt/unicode-converter)
- [Normalizador Unicode](https://cratex.app/pt/unicode-normalizer)
- [Conversor ASCII](https://cratex.app/pt/ascii-converter)
- [Conversor de Base](https://cratex.app/pt/base-converter)
...
- [Decodificador JWT](https://cratex.app/pt/jwt-decoder)
- [Verificador de assinatura JWT](https://cratex.app/pt/jwt-verifier)
- [Teste de expressões regulares](https://cratex.app/pt/regex-tester)
- [Tipo MIME](https://cratex.app/pt/mime-type-lookup)
...
- [Analisador de Expressões Cron](https://cratex.app/pt/cron-parser)
- [Gerador de expressões Cron](https://cratex.app/pt/cron-generator)
